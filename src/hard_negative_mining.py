...
def parse_data_from_json_file(train_dataset: str, min_data: int= 0, max_data: int = 1e10):
    ...
    Args:
        ...
        min_data (int): starts parsing after this example number
        max_data (int): stops parsing till this example number
...
def main(args):
    ...
    id_list, negative_candidates_sorted, data_dict = parse_data_from_json_file(args.dataset_path, 0, 150000)
    ...
    with open(os.path.join(args.output_path, 'distributions_dict1.pickle'), 'wb') as f:
